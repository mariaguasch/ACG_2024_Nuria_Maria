...
class IdEstimationModel2(nn.Module):
    #Python/prova_60epochs_batch400_resize150_conv64_kernel2.ckpt
    def __init__(self, num_classes):
        super(IdEstimationModel2, self).__init__()
...
class IdEstimationModel(nn.Module):
    #Python/50epochs_batch400_resize150_conv64.ckpt
    def __init__(self, num_classes):
...
transform = transforms.Compose([
    ...
    transforms.Resize((96, 96)),  # Resize the image to 150x150
